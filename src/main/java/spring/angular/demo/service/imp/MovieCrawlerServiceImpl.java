 ...
 */
@Service
public class MovieCrawlerServiceImpl implements MovieCrawlerService {
	private static final Logger logger = Logger.getLogger(MovieCrawlerServiceImpl.class);
	
	/**
	 * List of URLs that contains movie data, to be used by the Web crawler
	 */
	 ...
	 * 
	 * @return Set<Movie> - a data structure containing the movie data we obtained
	 *         from the web
	 */
	@Override
